...
f = open('articlePosLaju1.txt', encoding ="utf8")
article = f.read()
f.close()
...
def KMPSearch(pat, txt):
    ...
    while i < N:
        ...
        if j == M:
            ...
            print("Found word =", pat, ", in the article at index = " + str(i - j))  ## masukkan counter dkt sini
            j = lps[j - 1]
...
for neg_word in negative.split():
    KMPSearchNegative(neg_word, whole_word)
    j += 1
